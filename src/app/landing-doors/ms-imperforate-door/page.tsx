...
import { DoorOpen, ArrowRight, ArrowLeft, CheckCircle2, Building2, Settings } from "lucide-react";
import Reveal from "@/components/Reveal";
import Link from "next/link";
import { Badge } from "@/components/ui/badge";
import heroElevatorImg from "@/assets/hero-elevator.jpg";

export default function MSImperforateDoor() {
  const features = [
  ...
  const specifications = [
    { label: "Type", value: "MS Imperforate" },
    { label: "Style", value: "Accordion" },
    { label: "Material", value: "Metallic" },
    { label: "Operation", value: "Smooth" },
    { label: "Space", value: "Efficient" },
    { label: "Design", value: "Modern" },
  ];

  return (
    <div className="flex min-h-screen flex-col">
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-indigo-600 to-blue-700 py-28 md:py-36">
        ...
        <div className="container relative mx-auto px-4">
          <Reveal variant="fade-up">
            ...
            <h1 className="mb-6 text-5xl font-bold leading-tight text-white md:text-6xl lg:text-7xl">
              MS Imperforate <span className="bg-gradient-to-r from-yellow-200 via-yellow-100 to-white bg-clip-text text-transparent">Door</span>
            </h1>
            ...
            <Button size="lg" className="bg-white text-blue-700 hover:bg-white/90 hover:shadow-xl transition-all duration-300" asChild>
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            <Reveal variant="fade-up">
              <div className="relative aspect-video w-full overflow-hidden rounded-2xl">
                <img src={typeof heroElevatorImg === 'string' ? heroElevatorImg : heroElevatorImg.src} alt="MS Imperforate Door" className="h-full w-full object-cover" />
              ...
              <Card className="h-full border-2 border-primary/20 bg-gradient-to-br from-background to-muted/20 shadow-xl">
                ...
                <CardContent className="space-y-6">
                  <p className="text-lg leading-relaxed text-muted-foreground">
                    MS Imperforate doors feature a metallic accordion-style design that offers smooth operation and modern aesthetics. These doors are space-efficient, durable, and suitable for various commercial and residential applications where a modern look is desired.
                  </p>
              ...
              <Reveal key={index} variant="fade-up" delayMs={index * 100}>
                <Card className="group h-full border-2 border-border/50 bg-gradient-to-br from-background to-muted/20 transition-all duration-500 hover:border-primary/50 hover:shadow-xl hover:-translate-y-1">
                  <CardContent className="p-6">
                    <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-blue-500 to-indigo-500 shadow-lg transition-transform duration-300 group-hover:scale-110">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-indigo-600 to-blue-700 py-24">
        <div className="absolute inset-0 bg-grid-pattern opacity-10" />
        <div className="container relative mx-auto px-4 text-center">
          <Reveal variant="fade-up">
            <h2 className="mb-4 text-4xl font-bold text-white md:text-5xl">Need MS Imperforate Doors?</h2>
            <p className="mb-10 text-xl text-white/95">Contact us for accordion-style door solutions</p>
            <Button size="lg" className="bg-white text-blue-700 hover:bg-white/90 hover:shadow-2xl hover:scale-105 transition-all duration-300 h-16 px-10 text-lg font-semibold" asChild>
              <Link href="/contact">
