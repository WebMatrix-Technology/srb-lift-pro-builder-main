...
import { DoorOpen, ArrowRight, ArrowLeft, CheckCircle2, Building2, Palette } from "lucide-react";
...
export default function MSPowderCoatedDoor() {
  ...
  const specifications = [
    { label: "Type", value: "MS Powder Coated" },
    { label: "Colors", value: "Custom Available" },
    { label: "Finish", value: "Light Beige/Cream" },
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <section className="relative overflow-hidden bg-gradient-to-br from-yellow-600 via-amber-600 to-yellow-700 py-28 md:py-36">
        ...
        <div className="container relative mx-auto px-4">
          <Reveal variant="fade-up">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-white/20 px-5 py-2.5 text-sm font-semibold text-white backdrop-blur-md">
              ...
              MS Powder Coated Door
            </div>
            <h1 className="mb-6 text-5xl font-bold leading-tight text-white md:text-6xl lg:text-7xl">
              MS Powder Coated <span className="bg-gradient-to-r from-yellow-200 via-yellow-100 to-white bg-clip-text text-transparent">Door</span>
            </h1>
            ...
            <Button size="lg" className="bg-white text-yellow-700 hover:bg-white/90 hover:shadow-xl transition-all duration-300" asChild>
              ...
              <Card className="h-full border-2 border-primary/20 bg-gradient-to-br from-background to-muted/20 shadow-xl">
                ...
                <CardContent className="space-y-6">
                  <p className="text-lg leading-relaxed text-muted-foreground">
                    MS Powder Coated doors feature a light beige/cream colored finish with a darker frame, creating an elegant contrast. These doors offer custom color options, weather-resistant coating, and versatile design suitable for various building types and architectural styles.
                  </p>
              ...
              <Reveal key={index} variant="fade-up" delayMs={index * 100}>
                <Card className="group h-full border-2 border-border/50 bg-gradient-to-br from-background to-muted/20 transition-all duration-500 hover:border-primary/50 hover:shadow-xl hover:-translate-y-1">
                  <CardContent className="p-6">
                    <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-yellow-500 to-amber-500 shadow-lg transition-transform duration-300 group-hover:scale-110">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-yellow-600 via-amber-600 to-yellow-700 py-24">
        <div className="absolute inset-0 bg-grid-pattern opacity-10" />
        <div className="container relative mx-auto px-4 text-center">
          <Reveal variant="fade-up">
            <h2 className="mb-4 text-4xl font-bold text-white md:text-5xl">Need Powder Coated Doors?</h2>
            <p className="mb-10 text-xl text-white/95">Contact us for custom color door solutions</p>
            <Button size="lg" className="bg-white text-yellow-700 hover:bg-white/90 hover:shadow-2xl hover:scale-105 transition-all duration-300 h-16 px-10 text-lg font-semibold" asChild>
              <Link href="/contact">
