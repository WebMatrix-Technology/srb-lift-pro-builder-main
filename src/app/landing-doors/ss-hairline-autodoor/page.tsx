...
import { Shield, ArrowRight, ArrowLeft, CheckCircle2, Building2, Sparkles } from "lucide-react";
import Reveal from "@/components/Reveal";
import Link from "next/link";
import { Badge } from "@/components/ui/badge";
import heroElevatorImg from "@/assets/hero-elevator.jpg";

export default function SSHairlineAutodoor() {
  const features = [
    "Premium brushed finish",
    "Corrosion resistant",
    "Easy to clean",
    "Automatic operation",
    "Sleek hairline texture",
    "Premium appearance",
  ];
  ...
  const specifications = [
    ...
    { label: "Finish", value: "Hairline Texture" },
    { label: "Operation", value: "Fully Automatic" },
    { label: "Maintenance", value: "Easy Cleaning" },
    { label: "Appearance", value: "Premium Sleek" },
    { label: "Durability", value: "High Corrosion Resistance" },
  ];

  return (
    <div className="flex min-h-screen flex-col">
      <section className="relative overflow-hidden bg-gradient-to-br from-zinc-600 via-gray-600 to-zinc-700 py-28 md:py-36">
        ...
        <div className="container relative mx-auto px-4">
          <Reveal variant="fade-up">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-white/20 px-5 py-2.5 text-sm font-semibold text-white backdrop-blur-md">
              ...
              SS Hairline Autodoor
            </div>
            <h1 className="mb-6 text-5xl font-bold leading-tight text-white md:text-6xl lg:text-7xl">
              SS Hairline <span className="bg-gradient-to-r from-yellow-200 via-yellow-100 to-white bg-clip-text text-transparent">Autodoor</span>
            </h1>
            ...
            <Button size="lg" className="bg-white text-zinc-700 hover:bg-white/90 hover:shadow-xl transition-all duration-300" asChild>
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            <Reveal variant="fade-up">
              <div className="relative aspect-video w-full overflow-hidden rounded-2xl">
                <img src={typeof heroElevatorImg === 'string' ? heroElevatorImg : heroElevatorImg.src} alt="SS Hairline Autodoor" className="h-full w-full object-cover" />
              ...
              <Card className="h-full border-2 border-primary/20 bg-gradient-to-br from-background to-muted/20 shadow-xl">
                ...
                <CardContent className="space-y-6">
                  <p className="text-lg leading-relaxed text-muted-foreground">
                    SS Hairline Autodoor features a distinctive brushed stainless steel finish with a sleek hairline texture. This premium door offers automatic operation with a sophisticated appearance, making it ideal for high-end applications where aesthetics and functionality are equally important.
                  </p>
              ...
              <Reveal key={index} variant="fade-up" delayMs={index * 100}>
                <Card className="group h-full border-2 border-border/50 bg-gradient-to-br from-background to-muted/20 transition-all duration-500 hover:border-primary/50 hover:shadow-xl hover:-translate-y-1">
                  <CardContent className="p-6">
                    <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-zinc-500 to-gray-500 shadow-lg transition-transform duration-300 group-hover:scale-110">
            ...
            {applications.map((app, index) => (
              <Reveal key={index} variant="fade-up" delayMs={index * 50}>
                <div className="group flex items-center gap-4 rounded-xl bg-gradient-to-br from-primary/5 to-primary-hover/5 p-6 transition-all duration-300 hover:from-primary/10 hover:to-primary-hover/10 hover:shadow-md">
                  <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-zinc-500 to-gray-500 shadow-lg">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-zinc-600 via-gray-600 to-zinc-700 py-24">
        <div className="absolute inset-0 bg-grid-pattern opacity-10" />
        <div className="container relative mx-auto px-4 text-center">
          <Reveal variant="fade-up">
            <h2 className="mb-4 text-4xl font-bold text-white md:text-5xl">Need SS Hairline Autodoor?</h2>
            <p className="mb-10 text-xl text-white/95">Contact us for premium hairline finish door solutions</p>
            <Button size="lg" className="bg-white text-zinc-700 hover:bg-white/90 hover:shadow-2xl hover:scale-105 transition-all duration-300 h-16 px-10 text-lg font-semibold" asChild>
              <Link href="/contact">
