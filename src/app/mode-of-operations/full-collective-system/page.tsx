...
import { Settings, ArrowRight, ArrowLeft, CheckCircle2, Building2, Layers } from "lucide-react";
...
export default function FullCollectiveSystem() {
  ...
  const specifications = [
    { label: "System Type", value: "Full Collective" },
    { label: "Coverage", value: "All Floors" },
    { label: "Direction", value: "Bidirectional" },
    { label: "Efficiency", value: "High Traffic Management" },
    { label: "Allocation", value: "Smart Call Distribution" },
    { label: "Performance", value: "Optimal" },
  ];

  return (
    <div className="flex min-h-screen flex-col">
      <section className="relative overflow-hidden bg-gradient-to-br from-rose-600 via-pink-600 to-rose-700 py-28 md:py-36">
        ...
        <div className="container relative mx-auto px-4">
          <Reveal variant="fade-up">
            ...
            <h1 className="mb-6 text-5xl font-bold leading-tight text-white md:text-6xl lg:text-7xl">
              Full Collective <span className="bg-gradient-to-r from-yellow-200 via-yellow-100 to-white bg-clip-text text-transparent">System</span>
            </h1>
            <p className="mb-8 text-xl text-white/95 md:text-2xl">
              Complete collective control for all floors with efficient traffic management and optimal passenger distribution
            </p>
            <Button size="lg" className="bg-white text-rose-700 hover:bg-white/90 hover:shadow-xl transition-all duration-300" asChild>
              <Link href="/products">
            ...
            <Card className="mx-auto max-w-4xl border-2 border-primary/20 bg-gradient-to-br from-background to-muted/20 shadow-xl">
                ...
                <CardContent className="space-y-6">
                  <p className="text-lg leading-relaxed text-muted-foreground">
                    Full Collective System provides complete control for all floors, handling calls in both upward and downward directions. This system ensures efficient traffic management, optimal passenger distribution, and significantly reduced waiting times through intelligent call allocation.
                  </p>
              ...
              <Reveal key={index} variant="fade-up" delayMs={index * 100}>
                <Card className="group h-full border-2 border-border/50 bg-gradient-to-br from-background to-muted/20 transition-all duration-500 hover:border-primary/50 hover:shadow-xl hover:-translate-y-1">
                  <CardContent className="p-6">
                    <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-rose-500 to-pink-500 shadow-lg transition-transform duration-300 group-hover:scale-110">
            ...
            {applications.map((app, index) => (
              <Reveal key={index} variant="fade-up" delayMs={index * 50}>
                <div className="group flex items-center gap-4 rounded-xl bg-gradient-to-br from-primary/5 to-primary-hover/5 p-6 transition-all duration-300 hover:from-primary/10 hover:to-primary-hover/10 hover:shadow-md">
                  <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-rose-500 to-pink-500 shadow-lg">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-rose-600 via-pink-600 to-rose-700 py-24">
        <div className="absolute inset-0 bg-grid-pattern opacity-10" />
        <div className="container relative mx-auto px-4 text-center">
          <Reveal variant="fade-up">
            <h2 className="mb-4 text-4xl font-bold text-white md:text-5xl">Need Full Collective System?</h2>
            <p className="mb-10 text-xl text-white/95">Contact us for comprehensive control system solutions</p>
            <Button size="lg" className="bg-white text-rose-700 hover:bg-white/90 hover:shadow-2xl hover:scale-105 transition-all duration-300 h-16 px-10 text-lg font-semibold" asChild>
              <Link href="/contact">
