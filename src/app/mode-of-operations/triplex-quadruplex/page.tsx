...
import { Settings, ArrowRight, ArrowLeft, CheckCircle2, Building2, Network } from "lucide-react";
import Reveal from "@/components/Reveal";
import Link from "next/link";
import { Badge } from "@/components/ui/badge";
import heroElevatorImg from "@/assets/hero-elevator.jpg";

export default function TriplexQuadruplex() {
  const features = [
  ...
  const specifications = [
    { label: "System Type", value: "Triplex / Quadruplex" },
    { label: "Lifts", value: "3 or 4 Lifts" },
    { label: "Coordination", value: "Advanced" },
    { label: "Efficiency", value: "High" },
    { label: "Management", value: "Intelligent Traffic" },
    { label: "Performance", value: "Optimal" },
  ];

  return (
    <div className="flex min-h-screen flex-col">
      <section className="relative overflow-hidden bg-gradient-to-br from-amber-600 via-yellow-600 to-amber-700 py-28 md:py-36">
        ...
        <div className="container relative mx-auto px-4">
          <Reveal variant="fade-up">
            ...
            <h1 className="mb-6 text-5xl font-bold leading-tight text-white md:text-6xl lg:text-7xl">
              Triplex / <span className="bg-gradient-to-r from-yellow-200 via-yellow-100 to-white bg-clip-text text-transparent">Quadruplex</span>
            </h1>
            <p className="mb-8 text-xl text-white/95 md:text-2xl">
              Multi-lift coordination systems for high-rise buildings with advanced traffic management
            </p>
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            <Reveal variant="fade-up">
              <div className="relative aspect-video w-full overflow-hidden rounded-2xl">
                <img src={typeof heroElevatorImg === 'string' ? heroElevatorImg : heroElevatorImg.src} alt="Triplex Quadruplex" className="h-full w-full object-cover" />
              ...
              <Card className="h-full border-2 border-primary/20 bg-gradient-to-br from-background to-muted/20 shadow-xl">
                ...
                <CardContent className="space-y-6">
                  <p className="text-lg leading-relaxed text-muted-foreground">
                    Triplex / Quadruplex systems provide advanced multi-lift coordination for buildings with three or four lifts. These sophisticated systems offer intelligent traffic management, optimal passenger distribution, and significantly reduced waiting times through advanced call allocation algorithms.
                  </p>
              ...
              <Reveal key={index} variant="fade-up" delayMs={index * 100}>
                <Card className="group h-full border-2 border-border/50 bg-gradient-to-br from-background to-muted/20 transition-all duration-500 hover:border-primary/50 hover:shadow-xl hover:-translate-y-1">
                  <CardContent className="p-6">
                    <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-amber-500 to-yellow-500 shadow-lg transition-transform duration-300 group-hover:scale-110">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-amber-600 via-yellow-600 to-amber-700 py-24">
        <div className="absolute inset-0 bg-grid-pattern opacity-10" />
        <div className="container relative mx-auto px-4 text-center">
          <Reveal variant="fade-up">
            <h2 className="mb-4 text-4xl font-bold text-white md:text-5xl">Need Triplex/Quadruplex System?</h2>
            <p className="mb-10 text-xl text-white/95">Contact us for advanced multi-lift coordination solutions</p>
